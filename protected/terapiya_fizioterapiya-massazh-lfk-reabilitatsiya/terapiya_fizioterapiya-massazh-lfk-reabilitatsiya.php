...
<?php
$query = "SELECT * FROM `archive_terapiya_fizioterapiya-massazh-lfk-reabilitatsiya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Физиотерапия. Массаж. ЛФК. Реабилитация</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?terapiya_fizioterapiya-massazh-lfk-reabilitatsiya']");
