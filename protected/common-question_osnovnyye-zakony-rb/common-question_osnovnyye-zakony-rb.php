...
<?php
$query = "SELECT * FROM `archive_common-question_osnovnyye-zakony-rb`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Основные Законы РБ</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        foreach ($data as $user) {
            ...
            <td><?= $user['type'] ?></td>
            <td><a href="<?= $user['file'] ?>" target="_blank">закон<?= $user['num_akt'] ?></a></td>
          </tr>
          <?php
        }
        ?>
...
<script>
    ...
    let itemLi = baseNPAtree.children[0];
    itemLi.className = "nav-item menu-is-opening menu-open";
    let itemMenu = document.querySelector("[href='index.php?common-question_osnovnyye-zakony-rb']");
