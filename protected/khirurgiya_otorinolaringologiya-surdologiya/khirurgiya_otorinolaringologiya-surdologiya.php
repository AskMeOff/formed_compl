...
<?php
$query = "SELECT * FROM `archive_khirurgiya_otorinolaringologiya-surdologiya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Оториноларингология. Сурдология</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?khirurgiya_otorinolaringologiya-surdologiya']");
