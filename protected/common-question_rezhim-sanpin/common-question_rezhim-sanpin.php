...
<?php
$query = "SELECT * FROM `archive_common-question_rezhim-sanpin`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Режим работы и сан-эпид режим организаций здравоохранения. СанПИН</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?common-question_rezhim-sanpin']");
