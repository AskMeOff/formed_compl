...
<?php
$query = "SELECT * FROM `archive_terapiya_dermatologiya-venerologiya-kosmetologiya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Дерматология. Венерология. Косметология</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemLi = baseNPAtree.children[14];
    itemLi.className = "nav-item menu-is-opening menu-open";
    let itemMenu = document.querySelector("[href='index.php?terapiya_dermatologiya-venerologiya-kosmetologiya']");
