...
<?php
$query = "SELECT * FROM `archive_khirurgiya_onkologiya-mammologiya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Онкология, в т.ч.маммология</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?khirurgiya_onkologiya-mammologiya']");
