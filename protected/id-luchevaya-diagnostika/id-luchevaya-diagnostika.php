...
<?php
$query = "SELECT * FROM `archive_id-luchevaya-diagnostika`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Лучевая диагностика (в т.ч. рентгенологическая диагностика, компьютерная томография, магнитно-резонансная томография)</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemLi = baseNPAtree.children[6];
    itemLi.className = "nav-item menu-is-opening menu-open";
    let itemMenu = document.querySelector("[href='index.php?id-luchevaya-diagnostika']");
