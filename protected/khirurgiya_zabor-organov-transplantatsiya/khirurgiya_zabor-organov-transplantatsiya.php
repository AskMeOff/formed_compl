...
<?php
$query = "SELECT * FROM `archive_khirurgiya_zabor-organov-transplantatsiya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Забор органов и тканей, трансплантация</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?khirurgiya_zabor-organov-transplantatsiya']");
