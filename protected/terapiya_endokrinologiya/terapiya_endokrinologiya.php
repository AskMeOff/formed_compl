...
<?php
$query = "SELECT * FROM `archive_terapiya_endokrinologiya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Эндокринология</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?terapiya_endokrinologiya']");
