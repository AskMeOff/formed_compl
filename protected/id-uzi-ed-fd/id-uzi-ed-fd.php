...
<?php
$query = "SELECT * FROM `archive_id-uzi-ed-fd`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">УЗИ. Эндоскопическая диагностика. Функциональная диагностика</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?id-uzi-ed-fd']");
