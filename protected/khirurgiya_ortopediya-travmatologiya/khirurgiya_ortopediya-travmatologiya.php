...
<?php
$query = "SELECT * FROM `archive_khirurgiya_ortopediya-travmatologiya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Ортопедия. Травматология</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?khirurgiya_ortopediya-travmatologiya']");
