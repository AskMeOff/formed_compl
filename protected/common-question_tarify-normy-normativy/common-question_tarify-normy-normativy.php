...
<?php
$query = "SELECT * FROM `archive_common-question_tarify-normy-normativy`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Тарифы, нормы, нормативы</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?common-question_tarify-normy-normativy']");
