...
<?php
$query = "SELECT * FROM `archive_laboratornaya-diagnostik`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Лабораторная диагностика</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?laboratornaya-diagnostik']");
