...
<?php
    $query = "SELECT * FROM `archive_anesteziologiya-reanimatologiya_deyatelnost-s-narkot`";
...
<div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Деятельность, связанная с оборотом наркотических средств, психотропных веществ и их прекурсоров</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?anesteziologiya-reanimatologiya_deyatelnost-s-narkot']");
