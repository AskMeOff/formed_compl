...
<?php
$query = "SELECT * FROM `archive_terapiya_psikhoterapiya-narkologiya-psikhiatriya`";
...
<div class="col-12">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Психотерапия. Наркология. Психиатрия</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
...
<script>
    ...
    let itemMenu = document.querySelector("[href='index.php?terapiya_psikhoterapiya-narkologiya-psikhiatriya']");
